$(".tablas").on("click",".btnEditarCategoria",function(){ //debemos ponerle siempre un . antes del nombre de la variable,
	...
	var idCategoria =$(this).attr("idCategoria"); //decimos que la variable idUsuarios es igual a idUsuario,este idUsuario
	...
	datos.append("idCategoria",idCategoria); //aqui lo que hacemos es pasarle a la variabla datos,la variable
	...
	$.ajax({
		...
		success:function(respuesta){
			...
			swal({
			  title: "Recordatorio",
			  text: "!!Recuerde que la misma categoria no puede registrarse mas de una vez,hacerlo podria ocasionar un error!!",
			  icon: "warning"
			})
...
$(".tablas").on("click",".btnEliminarCategoria",function(){ //debemos ponerle siempre un . antes del nombre de la variable,
	//si es el nombre de una clase,como en este caso,tablas es una clase que viene del archivo usuarios.php,
	//btnEditarUsuario tambien es una clase,que viene de usuarios,asi que tambien llevara su punto.
